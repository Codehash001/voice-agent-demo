...
export default function BusinessesPage() {
    ...
    const fetchBusinesses = async () => {
        try {
            ...
            let allBusinesses = data.businesses || [];

            // Filter businesses for business admins
            if (user?.profile?.role === "business_admin" && user?.profile?.business_id) {
                allBusinesses = allBusinesses.filter(
                    (b: Business) => b.id === user.profile?.business_id
                );
            }
                ...
                <main className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <h1 className="text-xl font-semibold text-gray-900">
                            {isMasterAdmin ? "All Businesses" : "Your Business"}
                        </h1>
                        {isMasterAdmin && (
